...
- `io.github.dawciobiel:shelldialog:3.2.1`

Gradle:

```gradle
implementation("io.github.dawciobiel:shelldialog:3.2.1")
```
...
- `https://repo1.maven.org/maven2/io/github/dawciobiel/shelldialog/3.2.1/`
...
java -jar build/libs/shelldialog-3.2.1-all.jar

# Launch Spinner Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar spinner

# Launch Progress Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar progress

# Launch File Selection Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar file

# Launch Selection Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar singlechoice

# Launch Multi Choice Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar multichoice

# Launch Text Line Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar textline

# Launch Password Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar password

# Launch Yes/No Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar yesno

# Launch Form Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar form

# Launch Wizard Dialog example
java -jar build/libs/shelldialog-3.2.1-all.jar wizard
```
...
- from the JAR file name, for example `shelldialog-3.2.1.jar` or `shelldialog-3.2.1-all.jar`
- from `META-INF/MANIFEST.MF` inside the JAR
- from the command line with `java -jar build/libs/shelldialog-3.2.1-all.jar --version`
