...
- **Useful Input Defaults:**
    ...
    - `FileDialog` can optionally show a metadata preview panel for the currently focused entry, including human-readable file sizes and last modified timestamps.
